...
public class AlgarMoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String mensagemDesenvolver = ex.getCause() != null ? ex.getCause().toString() : ex.getCause().toString();
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		String mensagemUsuario = messageSource.getMessage("recurso.nao-permitida ", null, LocaleContextHolder.getLocale());
